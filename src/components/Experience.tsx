        ...
        <div className="space-y-12">
          {experiences.map((job, index) => (
            <ScrollReveal key={job.company}>
              <article className="group relative grid gap-6 border-l border-border pl-8 md:grid-cols-[200px_1fr]">
                <div
                ...
                <div>
                  ...
                  <ul className="mb-6 space-y-2">
                    {job.highlights.map((highlight) => (
                      <li key={highlight.slice(0, 48)} className="flex gap-3 text-text-muted">
