  ...
  return (
    <section id="contact" className="px-6 py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <ScrollReveal>
          <div className="rounded-2xl border border-border bg-surface-raised p-8 md:p-12">
            <p className="mb-6 max-w-lg text-lg text-text-muted">
              Open to remote full-time opportunities. Reach out directly — email is below for
              easy copy.
            </p>
            ...
            <div className="mb-8 rounded-xl border border-border bg-surface p-5">
              ...
              <a
                ...
                className="select-all font-mono text-lg text-accent hover:underline"
              >
                {personalInfo.email}
              </a>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <a
                ...
                className="group flex items-center justify-center gap-2 rounded-xl border border-border bg-surface px-6 py-4 text-sm font-semibold text-text transition-colors hover:border-accent/50 hover:text-accent"
              >
