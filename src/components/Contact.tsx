      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="rounded-2xl border border-border bg-surface-raised p-8 md:p-12">
          <p className="mb-8 max-w-lg text-lg text-text-muted">
            ...
            full-stack engineering, AI-assisted development, or mentoring.
          </p>

          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <a
              href={`mailto:${personalInfo.email}`}
              className="group flex items-center gap-4 rounded-xl border border-border bg-surface p-5 transition-colors hover:border-accent/50"
            >
