...
export const projects: Project[] = [
  ...
  },
  {
    ...
    screenshots: [
      { src: "chullav-images/hero-landing.webp", caption: "Landing page — prize showcase with CTA" },
      { src: "chullav-images/checkout-payment-methods.webp", caption: "3-step checkout with PayPhone, card & bank transfer" },
      { src: "chullav-images/ticket-packages.webp", caption: "Ticket package selector with pricing tiers" },
      { src: "chullav-images/progress-bonuses.webp", caption: "Sales progress bar + instant bonus numbers" },
      { src: "chullav-images/payment-security.webp", caption: "Payment security section + ticket lookup by email" },
      { src: "chullav-images/trust-social-proof.webp", caption: "Trust signals + 668 Instagram followers social proof" },
    ],
  },
];
